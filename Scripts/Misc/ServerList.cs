...
namespace Server.Misc
{
    ...
    // IMPORTANT!!! Discovered by testing that the external IP needs to be declared here for people to connect
    public static readonly string Address = "177.41.116.185";
